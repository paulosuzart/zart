...
:::caution[Coming Soon]
The Zart HTTP API server is currently in development. The endpoints documented here represent the planned interface. Subscribe to the GitHub repository for release announcements.
:::
