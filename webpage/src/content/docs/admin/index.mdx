...
# Resume a single pause rule by ID
zart resume-rule <rule_id> [--triggered-by ops]
...
- [**HTTP API Endpoints**](/admin/endpoints/) — full HTTP API reference
- [**Execution Management**](/api/execution-management/) — `DurableScheduler` API
- [**Deployment Options**](/deployment/options/) — running workers and admin endpoints in production
