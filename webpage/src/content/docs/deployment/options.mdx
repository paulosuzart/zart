...
description: Two ways to deploy Zart workers — embedded and sidecar.
---

import { Aside } from '@astrojs/starlight/components';

Zart workers are flexible: they can run inside your application process or as a separate container. Choose the strategy that fits your infrastructure.
