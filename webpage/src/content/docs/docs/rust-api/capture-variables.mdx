...
If you need to capture a value per iteration in a loop, include the loop index in the name — see [Durable Loops](/docs/rust-api/loops/) for patterns.
...
- [ZartStep Trait](/docs/rust-api/zart-step/) — full step definitions with retries and timeouts
- [Macros](/docs/rust-api/macros/) — ergonomic proc-macros for durable workflows
