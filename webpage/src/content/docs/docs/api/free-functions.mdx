...
Execute a step and return the three-way [`StepOutcome`](/docs/api/error-types/#stepoutcome).
...
See [**Steps → wait_for_event**](/docs/concepts/steps/#wait_for_event--external-signals) for the full walkthrough.
...
- [**Macros**](/docs/api/macros/) — `#[zart_durable]` and `#[zart_step]`
- [**Execution Management**](/docs/api/execution-management/) — `DurableScheduler`
- [**Error Types**](/docs/api/error-types/) — `StepOutcome`, `TaskError`, `ExecutionFailure`
