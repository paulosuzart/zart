...
- [**Timeouts and Cancellation**](/docs/concepts/timeouts/) — execution deadlines and event timeouts
- [**Macros**](/docs/api/macros/) — the `on_failure` attribute syntax
- [**Error Types**](/docs/api/error-types/) — detailed reference of every error type
