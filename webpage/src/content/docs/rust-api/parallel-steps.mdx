...
The [Parallel Steps example](/examples/parallel-steps/) runs three concurrent service health checks and aggregates the results — a complete, runnable demonstration of `zart::schedule` and `zart::wait`.
