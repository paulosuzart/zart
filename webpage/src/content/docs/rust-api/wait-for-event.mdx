...
The [Approval Workflow example](/examples/approval-workflow/) shows a complete human-in-the-loop workflow: validate a request, park at `wait_for_event`, deliver a manager decision, then act on it.
